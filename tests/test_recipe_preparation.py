...
class RecipePreparationTests(unittest.TestCase):
    def test_priority_plan_covers_sources_and_detection_subjects(self):
        ...
        self.assertEqual(plan["summary"]["recipe_ready"], 20)
        self.assertEqual(plan["summary"]["runtime_provider_ready"], 3)
        self.assertEqual(plan["summary"]["prepared_not_executable"], 0)
        ...
        self.assertEqual(by_id["opencl-loader"]["state"], "recipe-ready")
        self.assertEqual(by_id["gcc"]["state"], "runtime-provider-ready")
